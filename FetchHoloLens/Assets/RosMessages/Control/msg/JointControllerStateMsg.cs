...
namespace RosMessageTypes.Control
{
    ...
    public class JointControllerStateMsg : Message
    {
        ...
        public JointControllerStateMsg(HeaderMsg header, double set_point, double process_value, double process_value_dot, double error, double time_step, double command, double p, double i, double d, double i_clamp, bool antiwindup)
        {
            this.header = header;
