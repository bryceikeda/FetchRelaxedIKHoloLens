...
namespace RosMessageTypes.Control
{
    ...
    public class JointTrajectoryControllerStateMsg : Message
    {
        ...
        public JointTrajectoryControllerStateMsg(HeaderMsg header, string[] joint_names, Trajectory.JointTrajectoryPointMsg desired, Trajectory.JointTrajectoryPointMsg actual, Trajectory.JointTrajectoryPointMsg error)
        {
            this.header = header;
