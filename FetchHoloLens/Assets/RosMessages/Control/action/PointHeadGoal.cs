...
namespace RosMessageTypes.Control
{
    ...
    public class PointHeadGoal : Message
    {
        ...
        public PointHeadGoal(Geometry.PointStampedMsg target, Geometry.Vector3Msg pointing_axis, string pointing_frame, DurationMsg min_duration, double max_velocity)
        {
            this.target = target;
