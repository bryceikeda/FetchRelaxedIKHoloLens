...
public class TrajectoryPlanner : MonoBehaviour
{
    ...
    [SerializeField]
    string m_RosServiceName = "fetch_moveit";
    ...
    // Debug Variables
    public FetchMoverServiceResponse responseOut;
    ...
    void Start()
    {
        ...
        m_Ros.RegisterRosService<FetchMoverServiceRequest, FetchMoverServiceResponse>(m_RosServiceName);
        ...
        for (var i = 0; i < k_NumRobotJoints; i++)
        {
            ...
            m_JointArticulationBodies[i] = m_Fetch.transform.Find(linkName).GetComponent<ArticulationBody>();
        }
    ...
    FetchMoveitJointsMsg CurrentJointConfig()
    {
        var joints = new FetchMoveitJointsMsg();
    ...
    /// <summary>
    ///     Create a new FetchMoverServiceRequest with the current values of the robot's joint angles,
    ...
    {
        var request = new FetchMoverServiceRequest();
        ...
        m_Ros.SendServiceMessage<FetchMoverServiceResponse>(m_RosServiceName, request, TrajectoryResponse);
    }

    void TrajectoryResponse(FetchMoverServiceResponse response)
    {
