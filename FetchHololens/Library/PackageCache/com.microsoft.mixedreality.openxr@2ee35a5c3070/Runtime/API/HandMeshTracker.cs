    ...
    public class HandMeshTracker
    {
        ...
        public bool TryLocateHandMesh(FrameTime frameTime, out Pose pose, HandPoseType handPoseType = HandPoseType.Tracked)
        {
            ...
            return Feature.IsValidAndEnabled()
                && NativeLib.TryLocateHandMesh(Feature.NativeLibToken, m_handedness, frameTime, handPoseType, out pose);
        }
        ...
        public bool TryGetHandMesh(FrameTime frameTime, Mesh handMesh, HandPoseType handPoseType = HandPoseType.Tracked)
        {
            ...
            try
            {
                ...
                {
                    if (NativeLib.TryGetHandMeshBufferSizes(Feature.NativeLibToken, out uint maxVertexCount, out uint maxIndexCount))
                    {
                ...
                if (NativeLib.TryGetHandMesh(Feature.NativeLibToken, m_handedness, frameTime, handPoseType,
