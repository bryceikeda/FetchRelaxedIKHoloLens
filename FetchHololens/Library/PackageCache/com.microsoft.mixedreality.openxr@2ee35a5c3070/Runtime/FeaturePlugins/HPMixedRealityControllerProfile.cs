...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    /// </summary>
#if UNITY_EDITOR
    [UnityEditor.XR.OpenXR.Features.OpenXRFeature(UiName = uiName,
    ...
    internal class HPMixedRealityControllerProfile : OpenXRInteractionFeature
    {
        ...
        private const string uiName = "HP Reverb G2 Controller Profile (Deprecated)";
#else
        private const string uiName = "HP Reverb G2 Controller Profile";
#endif

#if UNITY_EDITOR
        protected override void GetValidationChecks(List<ValidationRule> results, BuildTargetGroup targetGroup)
        {
            HPMixedRealityControllerProfileValidator.GetValidationChecks(this, results, targetGroup);
        }
#endif
