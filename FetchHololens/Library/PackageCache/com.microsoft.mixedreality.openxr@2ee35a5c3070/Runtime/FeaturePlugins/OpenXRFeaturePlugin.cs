...
namespace Microsoft.MixedReality.OpenXR
{
        ...
        : OpenXRFeature, IOpenXRContext, ISubsystemPlugin where TPlugin : OpenXRFeaturePlugin<TPlugin>
    {
        ...
        private static OpenXRFeature m_feature = null;
        ...
        protected override void OnEnable()
        {
            ...
            MixedRealityFeaturePluginManagement.OnFeaturePluginInitializing(this);

            if (MixedRealityFeaturePluginManagement.NativeLibAvailable)
            {
